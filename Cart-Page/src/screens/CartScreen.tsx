...
const styles = StyleSheet.create({
  ...
  segmentTrack: {
    ...
    borderColor: COLORS.accent, height: 46, position: 'relative', overflow: 'hidden',
  },
  segmentThumb: {
    position: 'absolute', top: 3, width: '48%',
    bottom: 3, backgroundColor: COLORS.accent, borderRadius: 18,
  },
  segmentOption: { flex: 1, alignItems: 'center', justifyContent: 'center', zIndex: 1 },
  ...
  tipChip: {
    flex: 1, paddingVertical: 10, borderRadius: COLORS.pillRadius,
